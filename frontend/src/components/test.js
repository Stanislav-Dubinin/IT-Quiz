...
export class Test {
    ...
    prepareProgressBar() {
        for (let i = 0; i < this.quiz.questions.length; i++) {
            ...
            itemTextElement.className = 'test-progress-bar-item-test';
        ...
        try {
            ...
            if (result) {
                ...
                this.userResult.forEach(item => {
                    let answers = item.chosenAnswerId;
                    this.answersId.push(answers);
                });

                localStorage.setItem('answersId', this.answersId);
